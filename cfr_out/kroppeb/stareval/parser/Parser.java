    ...
    ExpressionElement getFinal(int endIndex) throws ParseException {
        if (!this.stack.isEmpty()) {
            if (this.peek() instanceof ExpressionElement) {
                ...
                throw new UnexpectedTokenException("The stack of tokens isn't empty at the end of the expression: " + String.valueOf(this.stack) + " top: " + String.valueOf(result), endIndex);
            }
            Element top = this.peek();
            ...
            throw new UnexpectedTokenException("The stack of tokens contains an unexpected token at the top: " + String.valueOf(this.stack), endIndex);
        }
