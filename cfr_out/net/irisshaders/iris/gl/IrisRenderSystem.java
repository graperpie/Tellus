...
public class IrisRenderSystem {
    ...
    public static void setShadowProjection(Matrix4f shadowProjection) {
        ...
        RenderSystem.setProjectionMatrix((Matrix4f)shadowProjection, (class_8251)class_8251.field_43361);
    }
    ...
    public static void backupAndDisableCullingState(boolean b) {
        cullingState = class_310.method_1551().field_1730;
        class_310.method_1551().field_1730 = class_310.method_1551().field_1730 && !b;
    }

    public static void restoreCullingState() {
        class_310.method_1551().field_1730 = cullingState;
        cullingState = true;
    }
    ...
    extends DSAUnsupported {
        ...
        public void bindTextureToUnit(int target, int unit, int texture) {
            if (GlStateManagerAccessor.getTEXTURES()[unit].field_5167 == texture) {
                return;
            }
            ARBDirectStateAccess.glBindTextureUnit((int)unit, (int)texture);
            GlStateManagerAccessor.getTEXTURES()[unit].field_5167 = texture;
        }
    ...
    implements DSAAccess {
        ...
        @Override
        public void copyTexSubImage2D(int destTexture, int target, int i, int i1, int i2, int i3, int i4, int width, int height) {
            int previous = GlStateManagerAccessor.getTEXTURES()[GlStateManagerAccessor.getActiveTexture()].field_5167;
