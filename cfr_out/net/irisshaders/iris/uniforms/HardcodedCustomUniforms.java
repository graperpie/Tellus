...
public class HardcodedCustomUniforms {
    ...
    private static float getHurtFactor() {
        ...
        return player.field_6235 > 0 || player.field_6213 > 0 ? 0.4f : 0.0f;
    }
    ...
    private static float getEyeSkyBrightness() {
        ...
        class_243 feet = HardcodedCustomUniforms.client.field_1719.method_19538();
        class_243 eyes = new class_243(feet.field_1352, HardcodedCustomUniforms.client.field_1719.method_23320(), feet.field_1350);
        class_2338 eyeBlockPos = class_2338.method_49638((class_2374)eyes);
        int skyLight = HardcodedCustomUniforms.client.field_1687.method_8314(class_1944.field_9284, eyeBlockPos);
        return skyLight * 16;
    }
    ...
    private static int getWorldDayTime() {
        ...
        long dayTime = level.method_8597().comp_641().orElse(timeOfDay % 24000L);
        return (int)dayTime;
    }
    ...
    private static float getRawPrecipitation() {
        ...
        class_1959.class_1963 precipitation = ((class_1959)storedBiome.comp_349()).method_48162(class_310.method_1551().field_1719.method_24515());
        return switch (precipitation) {
            case class_1959.class_1963.field_9382 -> 1.0f;
            case class_1959.class_1963.field_9383 -> 2.0f;
            default -> 0.0f;
        };
    }
