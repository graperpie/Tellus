...
public class CapturedRenderingState {
    ...
    public void setGbufferProjection(Matrix4f gbufferProjection) {
        this.gbufferProjection = new Matrix4f((Matrix4fc)gbufferProjection);
    }

    public Vector3d getFogColor() {
        if (class_310.method_1551().field_1687 == null || this.fogColor == null) {
    ...
    public void setFogColor(float red, float green, float blue) {
        this.fogColor = new Vector3d((double)red, (double)green, (double)blue);
    }
