...
implements VertexSerializer {
    public void serialize(long src, long dst, int vertexCount) {
        ...
        for (int i = 0; i < quadCount; ++i) {
            ...
            int tangent = NormalHelper.computeTangent(null, NormI8.unpackX((int)normal), NormI8.unpackY((int)normal), NormI8.unpackZ((int)normal), MemoryUtil.memGetFloat((long)src), MemoryUtil.memGetFloat((long)(src + 4L)), MemoryUtil.memGetFloat((long)(src + 8L)), MemoryUtil.memGetFloat((long)(src + 16L)), MemoryUtil.memGetFloat((long)(src + 20L)), MemoryUtil.memGetFloat((long)(src + 36L)), MemoryUtil.memGetFloat((long)(src + 4L + 36L)), MemoryUtil.memGetFloat((long)(src + 8L + 36L)), MemoryUtil.memGetFloat((long)(src + 16L + 36L)), MemoryUtil.memGetFloat((long)(src + 20L + 36L)), MemoryUtil.memGetFloat((long)(src + 36L + 36L)), MemoryUtil.memGetFloat((long)(src + 4L + 36L + 36L)), MemoryUtil.memGetFloat((long)(src + 8L + 36L + 36L)), MemoryUtil.memGetFloat((long)(src + 16L + 36L + 36L)), MemoryUtil.memGetFloat((long)(src + 20L + 36L + 36L)));
            float midU = 0.0f;
            float midV = 0.0f;
            ...
            midV /= 4.0f;
            for (int j = 0; j < 4; ++j) {
                MemoryIntrinsics.copyMemory((long)src, (long)dst, (int)36);
                ...
                src += 36L;
                dst += (long)IrisVertexFormats.ENTITY.method_1362();
            }
        }
    }
}
