...
public class FinalPassRenderer {
    ...
    public void renderFinalPass() {
        ...
        if (((Blaze3dRenderTargetExt)main).iris$getColorBufferVersion() != this.lastColorTextureVersion || main.method_30277() != this.lastColorTextureId) {
            this.lastColorTextureVersion = ((Blaze3dRenderTargetExt)main).iris$getColorBufferVersion();
            this.lastColorTextureId = main.method_30277();
            this.colorHolder.addColorAttachment(0, this.lastColorTextureId);
        }
        if (this.finalPass != null) {
            ...
            IrisRenderSystem.copyTexSubImage2D(main.method_30277(), 3553, 0, 0, 0, 0, 0, baseWidth, baseHeight);
        }
        RenderSystem.activeTexture((int)33984);
