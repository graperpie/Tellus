...
implements WorldRenderingPipeline {
    public VanillaRenderingPipeline() {
        ...
        WorldRenderingSettings.INSTANCE.setBlockTypeIds((Map<class_2248, BlockRenderType>)Object2ObjectMaps.emptyMap());
    }
    ...
    @Override
    public void renderShadows(LevelRendererAccessor worldRenderer, class_4184 camera) {
    }
