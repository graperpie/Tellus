...
BlendingStateHolder {
    ...
    public InnerWrappedRenderType(String name, class_1921 wrapped, class_4668 extra) {
        super(name, wrapped.method_23031(), wrapped.method_23033(), wrapped.method_22722(), wrapped.method_23037(), InnerWrappedRenderType.shouldSortOnUpload(wrapped), () -> ((class_1921)wrapped).method_23516(), () -> ((class_1921)wrapped).method_23518());
        this.extra = extra;
        this.wrapped = wrapped;
    }

    public static InnerWrappedRenderType wrapExactlyOnce(String name, class_1921 wrapped, class_4668 extra) {
